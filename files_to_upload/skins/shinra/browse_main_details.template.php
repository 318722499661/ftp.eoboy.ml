...
<table id="maintable" style="table-layout:fixed; width: 100%; white-space: nowrap;">
	<tr class="browse_rows_heading">
		<td colspan="1" class="browse_col_select"     ><a style="text-decoration: underline; cursor: pointer; cursor: hand;" onclick="CheckAll(document.BrowseForm);"                      title="Click to check or uncheck all rows (accesskey t)" accesskey="t"><?php echo __("All"); ?></a></td>
		<td colspan="2" class="browse_col_dirfilename"><a style="text-decoration: underline; cursor: pointer; cursor: hand;" onclick="<?php echo $sortArray["dirfilename"]["onclick"]; ?>" title="<?php echo $sortArray["dirfilename"]["title"]; ?>"><?php echo $sortArray["dirfilename"]["text"]; ?></a><?php echo $sortArray["dirfilename"]["icon"]; ?></td>
		<td colspan="1" class="browse_col_type"       ><a style="text-decoration: underline; cursor: pointer; cursor: hand;" onclick="<?php echo $sortArray["type"]["onclick"];        ?>" title="<?php echo $sortArray["type"]["title"];        ?>"><?php echo $sortArray["type"]["text"];        ?></a><?php echo $sortArray["type"]["icon"];        ?></td>
		<td colspan="1" class="browse_col_size"       ><a style="text-decoration: underline; cursor: pointer; cursor: hand;" onclick="<?php echo $sortArray["size"]["onclick"];        ?>" title="<?php echo $sortArray["size"]["title"];        ?>"><?php echo $sortArray["size"]["text"];        ?></a><?php echo $sortArray["size"]["icon"];        ?></td>
		<td colspan="1" class="browse_col_owner"      ><a style="text-decoration: underline; cursor: pointer; cursor: hand;" onclick="<?php echo $sortArray["owner"]["onclick"];       ?>" title="<?php echo $sortArray["owner"]["title"];       ?>"><?php echo $sortArray["owner"]["text"];       ?></a><?php echo $sortArray["owner"]["icon"];       ?></td>
		<td colspan="1" class="browse_col_group"      ><a style="text-decoration: underline; cursor: pointer; cursor: hand;" onclick="<?php echo $sortArray["group"]["onclick"];       ?>" title="<?php echo $sortArray["group"]["title"];       ?>"><?php echo $sortArray["group"]["text"];       ?></a><?php echo $sortArray["group"]["icon"];       ?></td>
		<td colspan="1" class="browse_col_type"       ><a style="text-decoration: underline; cursor: pointer; cursor: hand;" onclick="<?php echo $sortArray["permissions"]["onclick"]; ?>" title="<?php echo $sortArray["permissions"]["title"]; ?>"><?php echo $sortArray["permissions"]["text"]; ?></a><?php echo $sortArray["permissions"]["icon"]; ?></td>
		<td colspan="1" class="browse_col_permissions"><a style="text-decoration: underline; cursor: pointer; cursor: hand;" onclick="<?php echo $sortArray["mtime"]["onclick"];       ?>" title="<?php echo $sortArray["mtime"]["title"];       ?>"><?php echo $sortArray["mtime"]["text"];       ?></a><?php echo $sortArray["mtime"]["icon"];       ?></td>
		<td colspan="3" class="browse_col_actions"    ><?php echo __("Actions"); ?></td>
	</tr>
